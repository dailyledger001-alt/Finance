...
if(product==='finance'){
  ...
  assert(d.body.textContent.includes('Income')&&d.body.textContent.includes('Spent')&&d.body.textContent.includes('Budget used'),'Finance dashboard is not connected to finance data');
